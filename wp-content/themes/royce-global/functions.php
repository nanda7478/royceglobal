...
function twentysixteen_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Sort By Tags', 'twentysixteen' ),
		'id'            => 'sidebar-4',
		'description'   => __( 'Appears at the bottom of the content on posts and pages.', 'twentysixteen' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
/****************************custom post type for Market*********/
add_action('init', 'market_custom_init');  
 
/*-- Custom Post Init Begin --*/
function market_custom_init()
{
  $labels = array(
    'name' => _x('Market', 'post type general name'),
 ...
 $args = array(
  ...
  // Initialize New Taxonomy Labels
  $labels = array(
    'name' => _x( 'Market Category', 'taxonomy general name' ),
    ...
    // Custom taxonomy for Project Tags
    register_taxonomy('market_category',array('market'), array(
    'hierarchical' => true,
    'labels' => $labels,
    'show_ui' => true,
    'query_var' => true,
